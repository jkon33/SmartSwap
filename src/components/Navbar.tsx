...
import { Coins, ShieldAlert, LogOut, RefreshCw, Smartphone } from "lucide-react";
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <button
              ...
              id="navbar-android-btn"
              className="flex items-center gap-1.5 rounded-xl border border-emerald-200 bg-emerald-50 px-2.5 sm:px-3 py-1.5 text-xs font-semibold text-emerald-700 hover:bg-emerald-100 transition-colors"
              title="SmartSwap Android Application & APK Build"
            >
              <Smartphone className="h-3.5 w-3.5" />
              <span className="hidden xs:inline sm:inline">Android App</span>
            </button>
            ...
            {user ? (
              ...
              <div className="flex items-center space-x-2">
                <Link
                  to="/login"
                  className="text-sm font-semibold text-gray-600 hover:text-gray-900 px-2 sm:px-3 py-2 transition-colors"
                >
                  Log In
                </Link>
                <Link
                  to="/register"
                  className="rounded-xl bg-blue-600 px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold text-white shadow-sm hover:bg-blue-700 transition"
                >
                  Sign Up
                </Link>
              </div>
